        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2 className=" bg-purple-300 mb-6 text-[32px] font-bold uppercase text-dark sm:text-[40px] lg:text-[36px] xl:text-[40px]">
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">Karachi, Pakistan</p>
                </div>
              </div>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">(+92)302 257 8318</p>
                </div>
              </div>
            ...
            <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12">
              <form>
                ...
                <div>
                  <button
                    type="submit"
                    className="text-xl font-bold text-dark  p-3 px-6 pt-2 text-black  bg-brightRed rounded-full baseline hover:bg-purple-300 md:block"
                  >
                    Send Message
                  </button>
                </div>
